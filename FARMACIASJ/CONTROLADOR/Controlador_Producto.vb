Public Class Controlador_Producto
    ...
    Private Venta2 As Devolucion_Venta

    Public Function Buscar_CodigoBarras(ByVal Codigo As String, ByVal RVenta As Windows.Forms.Form, ByVal v As Integer) As Boolean
