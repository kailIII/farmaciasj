Public Class Buscar_Proveedor
    ...
    Private Sub Rif_TextChanged(ByVal sender As System.Object, ByVal e As Windows.Forms.KeyPressEventArgs) Handles Rif.KeyPress, Rif.TextChanged
        Dim Controlador_Proveedor As Controlador_Proveedor = New Controlador_Proveedor
    ...
    Private Sub Rif_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Rif.TextChanged, Rif.KeyPress
